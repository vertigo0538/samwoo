...
@section('page_content')
		<aside id="sidebar">
			...
			<div class="sidebar_border">
				<div class="menu"><a class="{{$title == 'peong'? $active = 'active' : $active = ''}}" href="{{url($title2.'/peong')}}">{{$title1[0]}}</a></div>	
				<div class="down_hover">
					<div class="menu down_arrow">
						<a class="{{$title == 'wing'? $active = 'active' : $active = ''}}" href="{{url($title2.'/wing/wing_0')}}">{{$title1[1]}}</a>
					</div>
					<div class="aru_sub">
						<ul>
				...
				<div class="down_hover">
				<div class="menu down_arrow">
					<a class="{{$title == 'topcar'? $active = 'active' : $active = ''}}" href="{{url($title2.'/topcar/topcar_0')}}">{{$title1[2]}}</a>
				</div>
				<div class="aru_sub">
					<ul>
				...
				<div class="menu"><a class="{{$title == 'dump'? $active = 'active' : $active = ''}}" href="{{url($title2.'/dump')}}">{{$title1[3]}}</a></div>	
				<div class="menu"><a class="{{$title == 'swing'? $active = 'active' : $active = ''}}" href="{{url($title2.'/swing')}}">{{$title1[4]}}</a></div>	
				<div class="empty"></div>
