...
@section('sub_content')
	<section class="description">
		...
		<p>Anti-Slip 합판은 방수합판위에 열경화성 페놀수지가 함침된 필름을 열압으로 접착시켜 생산한 합판으로 <br>
			온도와 습도 변화에 따른 수축 및 팽창이 현저히 낮고 충격 흡수 및 강도 보존율이 높아 <br>
	...
	<section class="cf">
		<h3>합판 상세 이미지</h3>
		<div>
			<p><img src="{{URL::asset('images/special/wing_2-3-1.png')}}" alt="유럽산 Anti-Slip 합판"></p>
			<span>유럽산 Anti-Slip 합판</span>
		</div>
		<div class="mgr">
			<p style="text-align:right;line-height:172px;"><img src="{{URL::asset('images/special/wing_2-3-2.png')}}" alt="유럽산 Anti-Slip 합판"></p>
			<span>유럽산 Anti-Slip 합판</span>
		</div>
	</section>
