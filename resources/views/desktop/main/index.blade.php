...
@section('content')
		...
		<div class="main_right cf">
			<section class="service">
				...
				<h2><img src="{{ URL::asset('images/main/service_h3.png') }}" alt="삼우특장플러스 전문서비" width="208"></h2>
			...
			<section class="delivery common_right">
				<h2><img src="{{ URL::asset('images/main/delivery_h3.png') }}" alt="배송관련 유의사항" width="140"></h2>
				<p>목재의 규격에 따라,<br>대물배송으로<br>처리됩니다.</p>
			</section>
			<section class="quota common_right">
				<a href="/step1">
					<h2><img src="{{ URL::asset('images/main/quota_h3.png') }}" alt="견적요청" width="65"></h2>
