...
$(function(){
    ...
    function addField() {
        ...
        clone = '<div class="select_box_wrap select_box_wrap2">'+
                ...
                '           <li>'+
                '               <label for="select4">'+
                '                   <img src="{{URL::asset('images/quota/special.png')}}" alt="">'+
                '                   <p>특장차</p>'+
                '               </label>'+
                ...
                '           <li>'+
                '               <label for="select6">'+
                '                   <img src="{{URL::asset('images/quota/construction.png')}}" alt="">'+
                '                   <p>건자재</p>'+
                '               </label>'+
...
// function reset1(){
//     $(".select_box_wrap1").find('option').remove();
//     $(".hi").remove();
// }
// function reset3(){
//     $(".select_box_wrap2").find('option').remove();
//     $(".hi").remove();
// }
// function reset3(){
//     $(".select_box_wrap3").find('option').remove();
//     $(".hi").remove();
// }
