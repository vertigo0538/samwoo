...
@section('sub_content')
	<section class="description img_1">
		...
		<img src="{{URL::asset('images/common/new_1-1.jpg')}}" alt="국내원목 시공이미지" class="mb10">
		<img src="{{URL::asset('images/common/new_1-2.jpg')}}" alt="국내원목 시공이미지">
	...
	<section class="cf">
		...
		<div class="">
			<p><img width="100%" height="100%" src="{{URL::asset('images/common/new_2-2.png')}}" alt="MLH(국내수입)"></p>
			<span>MLH(국내수입)</span>
		</div>
	</section>
@endsection