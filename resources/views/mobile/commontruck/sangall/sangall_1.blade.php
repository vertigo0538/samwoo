...
@section('sub_content')
	<section class="description img_1">
		...
		<img src="{{URL::asset('images/common/domestic_1-1.jpg')}}" alt="아피통 시공이미지">
		<img src="{{URL::asset('images/common/domestic_1-2.jpg')}}" alt="아피통 시공이미지">
	...
	<section class="cf">
		...
		<div class="mgr">
			<p><img height="100%" src="{{URL::asset('images/common/domestic_2-2.png')}}" alt=""></p>
			<span>신소재(보강목용)</span>
		</div>
	</section>
@endsection