...
@section('sub_content')
	<section class="description img_1">
		...
		<img src="{{URL::asset('images/common/cb_1.jpg')}}" alt="C/B 시공">
	</section>
	<section class="cf">
		<h3>목재 상세 이미지</h3>
		<div>
			<p><img src="{{URL::asset('images/common/cb_2-1.png')}}" alt=""></p>
			<span>아피통(갈비대용)</span>
		</div>
		<div>
		...
		<div class="">
			<p><img height="100%" width="100%" src="{{URL::asset('images/common/cb_2-3.png')}}" alt=""></p>
			<span>아피통(갈비대용)</span>
		</div>
	</section>
@endsection