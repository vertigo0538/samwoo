		...
		<ul class="cf">
			<li class="aru_sub {{$ex[1] == 'specialvehicle'? $active = 'on' : $active = ''}}">
				...
				<div id="wrapper" class="sub_menu">
					...
					<h3 class="bdtop"><a href="/specialvehicle/topcar/topcar_0">탑차용 바닥재</a></h3>
					<ul>
						<li><a href="/specialvehicle/topcar/topcar_0">목재타입</a></li>
						<li><a href="/specialvehicle/topcar/topcar_1">합판타입</a></li>
					</ul>
					<h3 class="bdtop"><a href="/specialvehicle/dump">덤프/특장차 라이너</a></h3>
			...
			<li class="aru_sub {{$ex[1] == 'commontruck'? $active = 'on' : $active = ''}}">
				...
				<span>(보강목&보수용목재)</span>
				<div class="sub_menu">
					<h3><a href="/commontruck/sangall/sangall_0">보강목</a></h3>
					<ul>
