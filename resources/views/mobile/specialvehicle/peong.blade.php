...
@section('sub_content')
	<section class="description img_1">
		...
		<p style="padding-bottom:0;">특장차용 목재 전문 제조 기업으로써 20년간 축적된 경험과 기술을 바탕으로 안정된 납기와 균일하고 월등한 품질.<br>
			고객과 기업상호간에 win-win 할수 있는 체재를 구축하여<br> 내,외부환경의 변동 등에 즉각적이고 탄력적인 대응을
